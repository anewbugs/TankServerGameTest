...
public static class NetManager {
	...
	public static void Send(MsgBase msg) {
		...
		byte[] sendBytes = new byte[msgLenth + len];
		//组装长度
		sendBytes[0] = (byte)(len);
		//组装名字
		Array.Copy(nameBytes, 0, sendBytes, msgLenth, nameBytes.Length);
		//组装消息体
		Array.Copy(bodyBytes, 0, sendBytes, msgLenth + nameBytes.Length, bodyBytes.Length);
		//写入队列
